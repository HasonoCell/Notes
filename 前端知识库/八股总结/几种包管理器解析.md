### <font style="color:rgb(15, 17, 21);">设置与查看镜像源</font>
<font style="color:rgb(15, 17, 21);">你可以通过以下命令来查看、设置或恢复镜像源。</font>

| <font style="color:rgb(15, 17, 21);">操作说明</font> | <font style="color:rgb(15, 17, 21);">命令</font> |
| --- | --- |
| **<font style="color:rgb(15, 17, 21);">查看当前镜像源</font>** | `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">npm config get registry</font>` |
| **<font style="color:rgb(15, 17, 21);">切换为淘宝镜像源</font>** | `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">npm config set registry https://registry.npmmirror.com</font>` |
| **<font style="color:rgb(15, 17, 21);">恢复为官方镜像源</font>** | `<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">npm config set registry https://registry.npmjs.org/</font>` |
...
### NPM 的幽灵依赖问题
#### 核心定义
**幽灵依赖**，也常被称为**幻影依赖**，指的是在一个 npm 包项目中，你的代码直接引用了某个**并未在你项目的 **`package.json`** 文件的 **`dependencies`**（或 **`devDependencies`**）字段中声明的包**。
...
#### 什么是**硬链接**与**符号链接？**
<font style="color:rgb(15, 17, 21);">让我们用“房子”和“地址”来进行比喻：</font>

+ **<font style="color:rgb(15, 17, 21);">硬盘上的物理数据（文件内容）</font>**<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">=</font><font style="color:rgb(15, 17, 21);"> </font>**<font style="color:rgb(15, 17, 21);">一栋真实的房子</font>**
+ **<font style="color:rgb(15, 17, 21);">硬链接</font>**<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">=</font><font style="color:rgb(15, 17, 21);"> </font>**<font style="color:rgb(15, 17, 21);">这栋房子的不同大门</font>**<font style="color:rgb(15, 17, 21);">。</font>
    - <font style="color:rgb(15, 17, 21);">房子可以有前门、后门、侧门。</font>
    - <font style="color:rgb(15, 17, 21);">无论你从哪扇门进入，你进入的都是</font>**<font style="color:rgb(15, 17, 21);">同一栋房子</font>**<font style="color:rgb(15, 17, 21);">。</font>
    - **<font style="color:rgb(15, 17, 21);">封掉一扇门（删除一个硬链接）</font>**<font style="color:rgb(15, 17, 21);">，你依然可以从其他门进入，房子本身完好无损。</font>
    - <font style="color:rgb(15, 17, 21);">只有</font>**<font style="color:rgb(15, 17, 21);">所有门都被封掉</font>**<font style="color:rgb(15, 17, 21);">后，这栋房子才变得无法访问，并被最终拆除（数据被删除）。</font>
    - **<font style="color:rgb(15, 17, 21);">所以，硬链接不是“指向”房子的指针，它本身就是一扇通往房子的、实实在在的门。</font>**<font style="color:rgb(15, 17, 21);"> 可以说，</font>**<font style="color:#DF2A3F;">硬链接就是文件本身。</font>**
+ **<font style="color:rgb(15, 17, 21);">符号链接</font>**<font style="color:rgb(15, 17, 21);"> </font><font style="color:rgb(15, 17, 21);">=</font><font style="color:rgb(15, 17, 21);"> </font>**<font style="color:rgb(15, 17, 21);">一张写着“房子地址”的纸条</font>**<font style="color:rgb(15, 17, 21);">。</font>
    - <font style="color:rgb(15, 17, 21);">这张纸条本身不是房子，它非常轻便，容易创建。</font>
    - <font style="color:rgb(15, 17, 21);">你拿着这张纸条，可以找到真正的房子。</font>
    - <font style="color:rgb(15, 17, 21);">如果</font>**<font style="color:rgb(15, 17, 21);">房子被拆了（原始文件被删）</font>**<font style="color:rgb(15, 17, 21);">，你这张纸条就成了一张废纸（链接断裂）。</font>
    - <font style="color:rgb(15, 17, 21);">如果</font>**<font style="color:rgb(15, 17, 21);">房子搬家了（文件被移动）</font>**<font style="color:rgb(15, 17, 21);">，而纸条上的地址没更新，你同样会找不到它。</font>
...
2. **硬链接（Hard Links）**：在为一个新项目安装相同的依赖包时，PNPM 直接**从全局存储创建硬链接到项目的 **`**<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">node_modules/.pnpm</font>**`**<font style="color:rgb(15, 17, 21);"> 目录下</font>**。硬链接几乎不占用额外的磁盘空间，<font style="color:rgb(15, 17, 21);">因为它只是增加了一个指向原始数据块的记录；</font><font style="color:rgb(15, 17, 21);">不同项目访问的实际上是磁盘上的同一份物理数据</font>。
